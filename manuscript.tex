...
Across all three expressive domains, cultural items are measured as binary indicators ($Y_{itj} \in \{0, 1\}$) reflecting semester-level participation or aesthetic preference. For public arts and cultural events, tracked across Waves 1 through 4, participation was measured by survey question Q45: ``\textit{In the past semester, have you attended any of the following cultural events?}'' Respondents indicated binary participation (``Yes'' = 1, ``No'' = 0) across 12 distinct activities spanning institutional highbrow, theatrical, and commercial popular venues: jazz performances; Latin, Spanish, or Salsa performances; classical music performances or symphonies; opera; musical theater or Broadway shows; stage plays or dramas; ballet or modern dance; art museums or galleries; science or history museums; rock or pop concerts; comedy clubs or stand-up shows; and movies in a cinema or theater.
...
Because the observation window differs between public events (Waves 1--4) and recorded media (Waves 1--6), the internal knot locations adapt naturally to each domain's temporal horizon while maintaining identical parametric complexity (three parameters per item per class). For public arts and cultural events ($t \in [0, 3]$), boundary knots are placed at $t = 0$ (Wave 1) and $t = 3$ (Wave 4), with an internal knot placed at $t = 1.5$ (between freshman spring and sophomore fall). This placement positions the inflection flexibility directly at the onset of the sophomore slump and rebound. For book reading types and musical genres ($t \in [0, 5]$), boundary knots are placed at $t = 0$ (Wave 1) and $t = 5$ (Wave 6), with an internal knot placed at the collegiate midpoint ($t = 2.5$, between sophomore fall and sophomore spring). This formulation captures transitions from underclassman to upperclassman years while enforcing linear boundary constraints at matriculation and junior year.
